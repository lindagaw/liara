...
################################################################################
tsne = TSNE()
nsamples, nx, ny = imgs_amazon.shape
amazon_embedded = tsne.fit_transform(imgs_amazon.reshape((nsamples,nx*ny)))
plot = sns.scatterplot(amazon_embedded[:,0], amazon_embedded[:,1], hue=y, legend='full', palette=palette)
