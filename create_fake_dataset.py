...
try:
    os.makedirs('generated_images//'+src + '_' + tgt)
except:
    pass
...
for obj in os.listdir("datasets//office-31//amazon//images//"):
    ...
    if os.path.isfile('generated_images//' + src + '_' + tgt + '//' + obj + '_images.png') and os.listdir('datasets//' + src + '_' + tgt + '_fake_dataset//'+src_obj+'//') != 0:
        ...
        optimizerD = optim.SGD(netD.parameters(), lr=lr, betas=(beta1, 0.999))
        optimizerD_tgt = optim.SGD(netD_tgt.parameters(), lr=lr, betas=(beta1, 0.999))
